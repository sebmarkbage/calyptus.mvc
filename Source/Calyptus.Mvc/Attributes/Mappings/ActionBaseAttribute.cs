...
namespace Calyptus.Mvc
{
    ...
    {
		protected IList<IMapping> Mappings;
		...
		public ActionBaseAttribute(IEnumerable<IMapping> mappings)
		{
			this.Mappings = mappings == null ? new List<IMapping>() : new List<IMapping>(mappings);
		}
